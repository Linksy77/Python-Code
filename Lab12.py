...
class Car(object):
    ...
    def get_make(self):
        ''' Returns the make of the calling Car object.'''
        return self.__make

    def get_model(self):
        ''' Returns the model of the calling Car object.'''
        return self.__model

    def get_mpg(self):
        ''' Returns the mpg of the calling Car object.'''
        return self.__mpg

    def get_tank_capacity(self):
        ''' Returns the tank capacity of the calling Car object.'''
        return self.__tank_capacity

    '''Write setters for mpg and tank_capacity.'''

    def set_make(self, newMake):
        ''' Takes input newMake and replaces the calling Car object's
            make with it.'''
        self.__make = newMake

    def set_model(self, newModel):
        ''' Takes input newModel and replaces the calling Car object's
            model with it.'''
        self.__model = newModel

    def set_mpg(self, newMpg):
        ''' Takes input newMpg and replaces the calling Car object's
            mpg with it.'''
        self.__mpg = newMpg

    def set_tank_capacity(self, newTankCap):
        ''' Takes input newTankCap and replaces the calling Car object's
            tank_capacity with it.'''
        self.__tank_capacity = newTankCap
...
class HybridCar(Car):  
    ...
    def __init__(self, make, model, mpg, tank_capacity, battery_kWh, miles_per_kWh):
        ''' Initializes a HybridCar object.
        '''
