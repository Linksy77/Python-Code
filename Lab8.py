...
00      read    r1          # Get n (count)
01      setn    r13 0       # Initialize r13
02      setn    r2 1        # Initialize second value used to calc. next value
03      copy    r3 r2       # Initialize temp. var. to store r13 during loop
04      jeqzn   r1 11       # Done if r1 = 0
05      write   r13         # Print Fibonacci number
06      copy    r3 r13      # Temp. var. (r3) storing prev. (just printed) Fib. num.
07      add     r13 r13 r2  # Change r13 = r13 + r2
08      copy    r2 r3       # Prev. Fib. num. assigned to r2
09      addn    r1 -1       # Change r1 = r1 - 1 (count decrease)
10      jumpn   04          # Repeat
11      halt                # End program
